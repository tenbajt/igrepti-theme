...
document.querySelectorAll('[data-element="gallery"]').forEach(function(element) {
  var thumbnails = element.nextElementSibling.children;

  thumbnails[0].dataset.state = 'selected';
  ...
  var swipe = new Swipe(element, {
    ...
    transitionEnd: function(index, elem) {
      ...
      thumbnails[index].dataset.state = 'selected';
    },
  });
